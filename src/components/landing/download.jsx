...
export function PhoneMockup({ screenImage, className = "", containerClassName = "" }) {
  return (
...
export default function DownloadAppHero() {
  return (
    <section className="overflow-hidden py-32 w-full">
      <div className="container mx-auto border-b border-border px-4">
        ...
        <div className="mt-28 flex items-end justify-center gap-4">
          ...
          <div className="order-2 h-[600px] w-full max-w-sm overflow-hidden md:h-[350px] lg:h-[450px] xl:h-[600px]">
            <PhoneMockup screenImage="https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-phone-1.svg" />
          </div>

          {/* Left phone - shorter */}
          <div className="order-1 hidden h-[250px] w-full max-w-sm overflow-hidden md:block lg:h-[350px] xl:h-[450px]">
            <PhoneMockup
              screenImage="https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-phone-2.svg"
              className="size-full"
            />
          </div>
          ...
          <div className="order-3 hidden h-[250px] w-full max-w-sm overflow-hidden md:block lg:h-[350px] xl:h-[450px]">
            <PhoneMockup
              screenImage="https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-phone-3.svg"
              className="size-full"
            />
          </div>
        </div>
